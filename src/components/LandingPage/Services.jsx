...
export default function Services({jsonData}) {
  ...
  return (
    ...
    <div className='row mt-4 service p-4'>
    <div className='col-12 service_heading text_xl '> {jsonData[active]?.name}<img  className="heading_image"  src={jsonData[active].logo}/> </div>
    <div cassName="col-12 mt-2 ">
      ...
      {/* SECOND SECTION */}
    <div className='col-12 service_heading text_xl small_margin'>{jsonData[1]?.name} <img  className="heading_image"  src={jsonData[1].logo}/> </div>
